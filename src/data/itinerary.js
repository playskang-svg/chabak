    ...
    points: [
      {
        ...
        tips: "천안 → 영덕 약 4시간. 당진영덕고속도로를 타고 내륙을 가로지릅니다.",
      },
      {
        id: "d1-opt1",
        name: "문경새재 도립공원",
        type: "waypoint",
        coords: [36.7574, 128.0783],
        desc: "고속도로에서 잠깐 빠져 다리를 펴기 좋은 곳. 제1관문까지 평탄한 흙길이라 아토와 걷기 편합니다.",
        tips: "왕복 1시간이면 충분. 주차장에 화장실 있습니다.",
      },
      {
        id: "d1-2",
        name: "안동 월영교",
