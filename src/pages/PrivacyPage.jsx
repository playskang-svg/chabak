  ...
  <div className="doc-page">
    <div className="doc-inner">
        ...
        <table className="doc-table">
          ...
          <tbody>
            <tr>
              ...
              <td>여행 일정, 장소 메모, 준비물 항목, 방문 표시, 업로드한 사진, 앱 제목·부제·프롬프트</td>
              <td>서비스 제공 및 동행자 간 공유</td>
            </tr>
            <tr>
              <td>자동으로 기록되는 정보</td>
              <td>AI 일정 생성 기능을 사용할 때의 접속 IP 주소</td>
      ...
      <section className="doc-section doc-callout">
        ...
        <p>
          따라서 <strong>남에게 알려지면 곤란한 내용은 입력하지 마시기 바랍니다.</strong> 메모와 사진은
          주소를 아는 제3자에게 노출될 수 있습니다.
        </p>
      </section>
      ...
      <section className="doc-section">
        ...
        <table className="doc-table">
          ...
          <tbody>
            ...
            <tr><td>Anthropic, PBC</td><td>AI 일정 생성 처리</td><td>해외</td></tr>
          </tbody>
        </table>
        <p>
          AI 일정 생성 기능을 사용할 때에 한해, 입력한 여행 프롬프트가 Anthropic으로 전송되어
          일정 생성에 사용됩니다. 이 기능을 사용하지 않으면 전송되지 않습니다.
        </p>
        <p>
          지도는 OpenStreetMap의 지도 이미지를 불러와 표시하며, 길찾기 버튼을 누르면 카카오맵 또는
          네이버지도로, "이 곳 검색해 보기"를 누르면 구글 검색으로 새 창이 열립니다. 검색어는 이 서비스에
          저장되지 않으며, 이동한 뒤에는 해당 사업자의 정책이 적용됩니다.
        </p>
      </section>
      ...
      <section className="doc-section">
        ...
        <ul className="doc-list">
          ...
          <li>AI 기능으로 일정을 새로 만들면 기존 일정·메모·방문 표시·준비물이 함께 삭제됩니다. 사진은 삭제되지 않습니다.</li>
