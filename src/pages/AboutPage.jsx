...
const STEPS = [
  {
    title: '1. 일정 훑어보기',
    body: '왼쪽 목록은 날짜순 여정이고, 오른쪽 지도에는 같은 장소가 일차 번호로 찍힙니다. 카드를 누르면 지도가 그 장소로 이동하고, 지도 우상단 "전체 여정" 버튼을 누르면 다시 전체가 한눈에 들어옵니다. 휴대폰에서는 아래쪽 "전체 여정" 버튼으로 지도를 엽니다. 카드 사이에는 "경로 포함"이 켜진 다음 장소까지의 거리와 주행시간이 표시됩니다. 직선거리로 어림한 값이라 실제 도로 사정에 따라 차이가 납니다.',
  },
  {
    title: '2. 갈지 말지 정하기',
  ...
  {
    title: '6. 이 곳 검색해 보기',
    body: '카드 아래 "이 곳 검색해 보기"에 궁금한 말을 적고 구글 검색을 누르면, 장소 이름과 함께 새 창에서 구글 검색 결과가 열립니다. 예를 들어 "근처 맛집"이라고 적으면 "영덕 강구항 근처 맛집"으로 찾습니다. 아무것도 적지 않고 눌러도 장소 이름으로 검색합니다. 암호는 필요 없습니다.',
  },
  {
    ...
    <div className="doc-inner">
      ...
      <section className="doc-section">
        ...
        <ul className="doc-list">
          ...
          <li>AI가 만든 일정은 참고용입니다. 방문 전에 영업 여부와 조건을 확인해 주세요.</li>
        </ul>
      </section>
